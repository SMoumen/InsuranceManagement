...
class ClientServiceTest {
    ...
    private static PersonDTO createValidPersonDTO(Long id) {
    ...
    private static CompanyDTO createValidCompanyDTO(Long id) {
    ...
    private static Person createPersonEntity() {
        ...
        person.setId(ClientServiceTest.TEST_CLIENT_ID);
    ...
    private static Company createCompanyEntity() {
        ...
        company.setId(ClientServiceTest.TEST_CLIENT_ID);
    ...
    private static Contract createContract(Long id, Client client, LocalDate endDate) {
